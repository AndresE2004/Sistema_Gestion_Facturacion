"""
Aplicación principal FastAPI - Versión Portable Corregida
...
try:
    from database_sqlite import init_database, get_database_path
    from routes import suscriptores_standalone, pagos_standalone, recibos_standalone, gastos_standalone, balance_standalone
    ...
    try:
        ...
        try:
            ...
            subprocess.check_call([
                ...
                "-r", os.path.join(PARENT_DIR, "requirements_portable.txt")
            ])
